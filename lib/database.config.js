...
export const supabaseConfig = {
  ...
  url: process.env.NEXT_PUBLIC_SUPABASE_URL ||  'https://tmogtqtoozzegppfozlf.supabase.co',
  
  // Chave pública (anon key) - pode ser usada no cliente
  anonKey: process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_IjksFK5n-2X-ej-P_MW0ZA_H5gpeWe6',
  
  // Chave de serviço (service role key) - apenas para operações server-side
  // NUNCA exponha esta chave no cliente!
  serviceRoleKey: process.env.SUPABASE_SERVICE_ROLE_KEY || 'sb_secret_0OEHezFCg-hmoaqIAOodYg_FuQRZkW1',
